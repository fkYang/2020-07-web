...
public class RedisUtils {
    ...
    static  Long contentTimeNums = 2l;//sig all
    TimeUnit contentTimeUnit = TimeUnit.HOURS;

    static  Long userTimeNums = 2l;
    TimeUnit userTimeUnit = TimeUnit.DAYS;
    ...
    public void setContetnAllExpireTime(String key){
        redisTemplate.expire(key, contentAllTimeNums, contentAllTimeUnit);
...
//    public <T>  List<Object> hmGetAll(String key){
//        HashOperations<String, Object, Object> hash = redisTemplate.opsForHash();
//        List<Object> values = hash.values(key);
//        return values;
//    }
    public <T>  List<T> hmGetAll(String key ,T object){
        HashOperations<String, Object, Object> hash = redisTemplate.opsForHash();
        List<T> values = (List<T>) hash.values(key);
        return values;
    }
